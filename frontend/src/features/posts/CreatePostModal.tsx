          ...
          {open && (
            <>
              ...
              <motion.div
                ...
                className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-24px)] max-w-md z-[51] bg-[#111] border border-white/[0.08] rounded-[28px] overflow-hidden shadow-2xl shadow-black/60"
              >
